...
public class HighScores 
{
    public static void main(String args[]) 
    {
        ...
        beginner[6] = new HighScores(7, "Bob", 65);
        ...
        intermediate[0] = new HighScores(1, "John", 10.5);
        ...
        intermediate[6] = new HighScores(7, "Bob", 165);
        ...
        expert[6] = new HighScores(7, "Bob", 265);
    ...
    public void print() {
        System.out.println(ranking + ".\t" + playerName + "\t" + time);
    }
}
